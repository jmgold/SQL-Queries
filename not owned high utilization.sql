...
ON
l.item_record_id = i.id AND i.item_status_code NOT IN ('n','m','w','o')
JOIN
sierra_view.record_metadata m
ON
i.id = m.id AND m.creation_date_gmt::DATE < '2019-01-01'
JOIN
...
GROUP BY 1,2,3
HAVING
COUNT(i.id) FILTER (WHERE i.location_code ~ '^brk') = 0
ORDER BY 6 DESC,1
LIMIT 500