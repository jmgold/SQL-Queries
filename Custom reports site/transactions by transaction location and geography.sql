...
FROM (
  ...
  JOIN sierra_view.bib_record_item_record_link l
    ON t.bib_record_id = l.bib_record_id
  ...
  WHERE CASE
	 ...
	 WHEN  {{location}} = '^cam' THEN (t.stat_group_code_num BETWEEN '210' AND '219' OR t.stat_group_code_num IN ('994','997')) 
	 ...
	 WHEN  {{location}} = '^ca' THEN (t.stat_group_code_num BETWEEN '210' AND '299' OR t.stat_group_code_num IN ('994','997'))
	 ...
	 WHEN  {{location}} = '^fpl' THEN t.stat_group_code_num BETWEEN '360' AND '369' OR t.stat_group_code_num = '961'
	 WHEN  {{location}} = '^fp3' THEN t.stat_group_code_num = '373'
	 WHEN  {{location}} = '^fp2' THEN t.stat_group_code_num BETWEEN '370' AND '379'
	 WHEN  {{location}} = '^fp' THEN t.stat_group_code_num BETWEEN '360' AND '379' OR t.stat_group_code_num = '961'
	 ...
	 WHEN  {{location}} = '^med' THEN t.stat_group_code_num BETWEEN '480' AND '489' OR t.stat_group_code_num = '983'
	 ...
	 WHEN  {{location}} = '^sud' THEN t.stat_group_code_num BETWEEN '690' AND '699' OR t.stat_group_code_num = '971'
	 ...
	 WHEN  {{location}} = '^wel' THEN t.stat_group_code_num BETWEEN '750' AND '759' OR t.stat_group_code_num = '951'
	 ...
	 WHEN  {{location}} = '^we' THEN t.stat_group_code_num BETWEEN '750' AND '779' OR t.stat_group_code_num = '951'
	 WHEN  {{location}} = '^win' THEN t.stat_group_code_num BETWEEN '780' AND '789'
	 WHEN  {{location}} = '^wob' THEN t.stat_group_code_num BETWEEN '790' AND '799' OR t.stat_group_code_num = '973'
