...
FROM (
  SELECT
    ...
    */
    ...
    COUNT({{bib_or_item}}) FILTER(WHERE SUBSTRING(i.location_code FROM 1 FOR 3) = 'wlm') AS "WALTHAM",
    ...
    COUNT({{bib_or_item}}) FILTER(WHERE SUBSTRING(i.location_code FROM 1 FOR 3) = 'win') AS "WINCHESTER",
