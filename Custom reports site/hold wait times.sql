...
AND h.pickup_location_code ~ {{location}} AND h.is_frozen = FALSE AND h.placed_gmt::DATE < CURRENT_DATE
JOIN
...
ON
l.order_record_id = o.id AND o.order_status_code = 'o'
JOIN sierra_view.order_record_cmf cmf
ON o.id = cmf.order_record_id AND cmf.location_code ~ {{location}}
