...
ON
(bs.record_metadata_id = r2.id OR bs.record_metadata_id = l.bib_record_id) AND bs.bool_info_id = {{review_file}}
{{/if include_review_file}}

WHERE
r.location_code ~ {{location}}
...
JOIN
sierra_view.order_record_cmf r
ON
l.order_record_id = r.order_record_id
JOIN
sierra_view.record_metadata rb 
ON
l.bib_record_id = rb.id
...
JOIN
sierra_view.holding_record_location r
ON
l.holding_record_id = r.holding_record_id
JOIN
sierra_view.record_metadata rb 
ON
l.bib_record_id = rb.id
