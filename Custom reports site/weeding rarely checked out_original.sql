...
NOTE: Has been replaced by updated version using the checkout table intstead of the fine table due to libraries having gone fines free and the absence of data
*/
