...
Variant form of collection development report found here https://github.com/Minuteman-Library-Network/SQL-Queries/blob/master/Custom%20reports%20site/collection%20development%20report.sql
Groups data on a custom call number range table, as requested for Pine Manor College
*/
