...
CASE
	...
	WHEN b.material_code IN ('a', '2', '9', 'c', 'f') AND ((SUBSTRING(i.location_code,4,1) = 'y') OR i.itype_code_num IN ('100','101','102','103','104','105','106','109')) THEN 'H12_YA_Books'
	...
	WHEN b.material_code IN ('a', '2', '9', 'c', 'f') AND ((SUBSTRING(i.location_code,4,1) = 'j') OR i.itype_code_num IN ('150','151','152','153','154','155','156','157','160'))THEN 'H23_Childrens_Books'
	...
	WHEN b.material_code IN ('a', '2', '9', 'c', 'f') AND (SUBSTRING(i.location_code,4,1) NOT IN ('j','y')) THEN 'H1_Adult_Books'
...
WHERE
i.itype_code_num NOT IN ('239','240','241', '242', '244', '249', '80')
GROUP BY 1,2,3
ORDER BY 1
