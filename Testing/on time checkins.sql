...
AND CASE
	WHEN  '^wob' = '^act' THEN t.stat_group_code_num BETWEEN '100' AND '109'
	--location using the form ^act in order to reuse an existing filter
	WHEN  '^wob' = '^arl' THEN (t.stat_group_code_num BETWEEN '110' AND '119' OR t.stat_group_code_num = '996')
	WHEN  '^wob' = '^ar2' THEN t.stat_group_code_num BETWEEN '120' AND '129'
	WHEN  '^wob' = '^ar' THEN (t.stat_group_code_num BETWEEN '110' AND '129' OR t.stat_group_code_num = '996')
	WHEN  '^wob' = '^ash' THEN t.stat_group_code_num BETWEEN '130' AND '139'
	WHEN  '^wob' = '^bed' THEN t.stat_group_code_num BETWEEN '140' AND '149'
	WHEN  '^wob' = '^blm' THEN t.stat_group_code_num BETWEEN '150' AND '179'
	WHEN  '^wob' = '^brk' THEN t.stat_group_code_num BETWEEN '180' AND '189'
	WHEN  '^wob' = '^br2' THEN t.stat_group_code_num BETWEEN '190' AND '199'
	WHEN  '^wob' = '^br3' THEN t.stat_group_code_num BETWEEN '200' AND '209'
	WHEN  '^wob' = '^br' THEN t.stat_group_code_num BETWEEN '180' AND '209'
	WHEN  '^wob' = '^cam' THEN (t.stat_group_code_num BETWEEN '210' AND '219' OR t.stat_group_code_num = '994' OR t.stat_group_code_num = '997') 
	WHEN  '^wob' = '^ca3' THEN t.stat_group_code_num BETWEEN '230' AND '239'
	WHEN  '^wob' = '^ca4' THEN t.stat_group_code_num BETWEEN '240' AND '249'
	WHEN  '^wob' = '^ca5' THEN t.stat_group_code_num BETWEEN '250' AND '259'
	WHEN  '^wob' = '^ca6' THEN t.stat_group_code_num BETWEEN '260' AND '269'
	WHEN  '^wob' = '^ca7' THEN t.stat_group_code_num BETWEEN '270' AND '279'
	WHEN  '^wob' = '^ca8' THEN t.stat_group_code_num BETWEEN '280' AND '289'
	WHEN  '^wob' = '^ca9' THEN t.stat_group_code_num BETWEEN '290' AND '299'
	WHEN  '^wob' = '^ca' THEN (t.stat_group_code_num BETWEEN '210' AND '299' OR t.stat_group_code_num = '994' OR t.stat_group_code_num = '997')
	WHEN  '^wob' = '^con' THEN t.stat_group_code_num BETWEEN '300' AND '309'
	WHEN  '^wob' = '^co2' THEN t.stat_group_code_num BETWEEN '310' AND '319'
	WHEN  '^wob' = '^co' THEN t.stat_group_code_num BETWEEN '300' AND '319'
	WHEN  '^wob' = '^ddm' THEN t.stat_group_code_num BETWEEN '320' AND '329'
	WHEN  '^wob' = '^dd2' THEN t.stat_group_code_num BETWEEN '330' AND '339'
	WHEN  '^wob' = '^dd' THEN t.stat_group_code_num BETWEEN '320' AND '339'
	WHEN  '^wob' = '^dea' THEN t.stat_group_code_num BETWEEN '340' AND '349'
	WHEN  '^wob' = '^dov' THEN t.stat_group_code_num BETWEEN '350' AND '359'
	WHEN  '^wob' = '^fpl' THEN t.stat_group_code_num BETWEEN '360' AND '369'
	WHEN  '^wob' = '^fp3' THEN t.stat_group_code_num = '373'
	WHEN  '^wob' = '^fp2' THEN t.stat_group_code_num BETWEEN '370' AND '379'
	WHEN  '^wob' = '^fp' THEN t.stat_group_code_num BETWEEN '360' AND '379'
	WHEN  '^wob' = '^frk' THEN t.stat_group_code_num BETWEEN '380' AND '389'
	WHEN  '^wob' = '^fst' THEN t.stat_group_code_num BETWEEN '390' AND '399'
	WHEN  '^wob' = '^hol' THEN t.stat_group_code_num BETWEEN '400' AND '409'
	WHEN  '^wob' = '^las' THEN t.stat_group_code_num BETWEEN '410' AND '419'
	WHEN  '^wob' = '^lex' THEN t.stat_group_code_num BETWEEN '420' AND '439'
	WHEN  '^wob' = '^lin' THEN t.stat_group_code_num BETWEEN '440' AND '449'
	WHEN  '^wob' = '^may' THEN t.stat_group_code_num BETWEEN '450' AND '459'
	WHEN  '^wob' = '^med' THEN t.stat_group_code_num BETWEEN '480' AND '489'
	WHEN  '^wob' = '^mil' THEN t.stat_group_code_num BETWEEN '490' AND '499'
	WHEN  '^wob' = '^mld' THEN t.stat_group_code_num BETWEEN '500' AND '509'
	WHEN  '^wob' = '^mwy' THEN t.stat_group_code_num BETWEEN '520' AND '529'
	WHEN  '^wob' = '^nat' THEN t.stat_group_code_num BETWEEN '530' AND '539'
	WHEN  '^wob' = '^na2' THEN t.stat_group_code_num BETWEEN '540' AND '549'
	WHEN  '^wob' = '^na3' THEN t.stat_group_code_num BETWEEN '550' AND '559'
	WHEN  '^wob' = '^na' THEN t.stat_group_code_num BETWEEN '530' AND '559'
	WHEN  '^wob' = '^nee' THEN t.stat_group_code_num BETWEEN '570' AND '579'
	WHEN  '^wob' = '^nor' THEN t.stat_group_code_num BETWEEN '580' AND '589'
	WHEN  '^wob' = '^ntn' THEN t.stat_group_code_num BETWEEN '590' AND '599'
	WHEN  '^wob' = '^oln' THEN t.stat_group_code_num BETWEEN '620' AND '629'
	WHEN  '^wob' = '^som' THEN t.stat_group_code_num BETWEEN '640' AND '649'
	WHEN  '^wob' = '^so2' THEN t.stat_group_code_num BETWEEN '650' AND '659'
	WHEN  '^wob' = '^so3' THEN t.stat_group_code_num BETWEEN '660' AND '669'
	WHEN  '^wob' = '^so' THEN t.stat_group_code_num BETWEEN '640' AND '679'
	WHEN  '^wob' = '^sto' THEN t.stat_group_code_num BETWEEN '680' AND '689'
	WHEN  '^wob' = '^sud' THEN t.stat_group_code_num BETWEEN '690' AND '699'
	WHEN  '^wob' = '^wlm' THEN t.stat_group_code_num BETWEEN '700' AND '709'
	WHEN  '^wob' = '^wat' THEN t.stat_group_code_num BETWEEN '710' AND '739'
	WHEN  '^wob' = '^wyl' THEN t.stat_group_code_num BETWEEN '740' AND '749'
	WHEN  '^wob' = '^wel' THEN t.stat_group_code_num BETWEEN '750' AND '759'
	WHEN  '^wob' = '^we2' THEN t.stat_group_code_num BETWEEN '760' AND '769'
	WHEN  '^wob' = '^we3' THEN t.stat_group_code_num BETWEEN '770' AND '779'
	WHEN  '^wob' = '^we' THEN t.stat_group_code_num BETWEEN '750' AND '779'
	WHEN  '^wob' = '^win' THEN t.stat_group_code_num BETWEEN '780' AND '789'
	WHEN  '^wob' = '^wob' THEN t.stat_group_code_num BETWEEN '790' AND '799'
	WHEN  '^wob' = '^wsn' THEN t.stat_group_code_num BETWEEN '800' AND '809'
	WHEN  '^wob' = '^wwd' THEN t.stat_group_code_num BETWEEN '810' AND '819'
	WHEN  '^wob' = '^ww2' THEN t.stat_group_code_num BETWEEN '820' AND '829'
	WHEN  '^wob' = '^ww' THEN t.stat_group_code_num BETWEEN '810' AND '829'
	WHEN  '^wob' = '^pmc' THEN t.stat_group_code_num BETWEEN '830' AND '839'
	WHEN  '^wob' = '^reg' THEN t.stat_group_code_num BETWEEN '840' AND '849'
	WHEN  '^wob' = '^shr' THEN t.stat_group_code_num BETWEEN '850' AND '859'
END
GROUP BY 1
