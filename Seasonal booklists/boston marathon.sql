...
--Limit to a subject
AND (REPLACE(d.index_entry, ' ', '') LIKE 'marathonrunning%' OR REPLACE(d.index_entry, ' ', '') LIKE '%bostonmarathon%' OR REPLACE(d.index_entry, ' ', '') LIKE '%runners(sports)%')
AND NOT (REPLACE(d.index_entry, ' ', '') LIKE '%bombing%' OR REPLACE(d.index_entry, ' ', '') LIKE '%fiction%' OR REPLACE(d.index_entry, ' ', '') LIKE '%terrorism%')
WHERE
