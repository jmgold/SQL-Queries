...
-- Not Cataloged in Childrens or YA
...
--Limit to a subject
AND REPLACE(d.index_entry, ' ', '') NOT LIKE '%fiction%' AND (REPLACE(d.index_entry, ' ', '') LIKE 'treatyofversailles%' OR REPLACE(d.index_entry, ' ', '') LIKE '%worldwar19141918peace%' OR REPLACE(d.index_entry, ' ', '') LIKE 'armisticeday%')
