...
--Limit to a subject
AND ((v.field_content LIKE '%Facebook (Firm)%' OR v.field_content LIKE '%Zuckerberg, Mark%' OR v.field_content LIKE '%Online social networks%') AND v.field_content NOT LIKE '%Fiction%' AND v.field_content NOT LIKE '%(Electronic resource)%')
