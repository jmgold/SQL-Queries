...
--Limit to a subject
AND (v.field_content LIKE '|aAfrican Americans|vBiography%' OR v.field_content LIKE '|aAfrican American women|vBiography%' OR v.field_content LIKE '|aAfrican Americans|xHistory%')
WHERE
