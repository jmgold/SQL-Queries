...
--Limit to a subject
AND (REPLACE(d.index_entry, ' ', '') LIKE 'georgeiiikingofgreatbritain17381820%' OR REPLACE(d.index_entry, ' ', '') LIKE 'foundingfathersoftheunitedstatesbiography%' OR REPLACE(d.index_entry, ' ', '') LIKE 'mirandalinmanuel1980hamilton%' OR REPLACE(d.index_entry, ' ', '') LIKE 'hamiltonalexander1757-1804%')
