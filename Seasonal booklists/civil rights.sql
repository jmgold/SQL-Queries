...
--Limit to a subject
AND (v.field_content LIKE 'King, Martin Luther,|cJr.,|d1929-1968%' OR v.field_content LIKE '%Civil rights workers%' OR v.field_content LIKE '%African Americans|xCivil rights|xHistory%' OR v.field_content LIKE '%Civil rights movements|zUnited States%')
