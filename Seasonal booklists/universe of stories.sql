...
--Limit to a subject
AND (REPLACE(d.index_entry, ' ', '') LIKE '%projectapollo%' OR REPLACE(d.index_entry, ' ', '') LIKE '%outerspaceexploration%'OR REPLACE(d.index_entry, ' ', '') LIKE '%lifeonotherplanets%' OR REPLACE(d.index_entry, ' ', '') LIKE '%projectapollospacerobotics%' OR REPLACE(d.index_entry, ' ', '') LIKE '%planets%' OR REPLACE(d.index_entry, ' ', '') LIKE '%solarsystem%' OR REPLACE(d.index_entry, ' ', '') LIKE '%astronomy%')
WHERE
