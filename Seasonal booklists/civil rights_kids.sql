...
--Limit to a subject
AND (REPLACE(d.index_entry, ' ', '') LIKE 'kingmartinlutherjr1929%' OR REPLACE(d.index_entry, ' ', '') LIKE '%civilrightsworkers%' OR REPLACE(d.index_entry, ' ', '') LIKE '%africanamericanscivilrightshistory%' OR REPLACE(d.index_entry, ' ', '') LIKE '%civilrightsmovementsunitedstates%')
WHERE
