...
--Limit to a subject
AND (v.field_content LIKE '%Computer programming%' OR v.field_content LIKE '%computer programmers%' OR v.field_content LIKE '%Technology%' OR v.field_content LIKE '%scientists%' OR v.field_content LIKE '%Engineering%' OR v.field_content LIKE '%Technology%' OR v.field_content LIKE '%Robotics%')
WHERE
