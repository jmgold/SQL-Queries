...
Generates list for www.minlib.net
*/
SELECT *
FROM(
SELECT
...
AND (REPLACE(d.index_entry, ' ', '') LIKE '%computerprogramming%' OR REPLACE(d.index_entry, ' ', '') LIKE '%computerprogrammers%' OR REPLACE(d.index_entry, ' ', '') LIKE '%technology%' OR REPLACE(d.index_entry, ' ', '') LIKE '%scientists%' OR REPLACE(d.index_entry, ' ', '') LIKE '%engineering%' OR REPLACE(d.index_entry, ' ', '') LIKE '%technology%' OR REPLACE(d.index_entry, ' ', '') LIKE '%robotics%')
WHERE
