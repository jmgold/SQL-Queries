...
GROUP BY 1
HAVING
COUNT(*) FILTER(WHERE f.assessed_gmt::DATE BETWEEN '2026-04-01' AND '2026-06-30') > 0
)
...
AND f.assessed_gmt::DATE BETWEEN '2026-04-01' AND '2026-06-30'-- CURRENT_DATE - INTERVAL '1 week'
ORDER BY 2,1