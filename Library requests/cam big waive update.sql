...
GROUP BY 1
HAVING
COUNT(*) FILTER(WHERE f.assessed_gmt::DATE BETWEEN '2025-03-01' AND '2025-04-30') > 0
)
...
AND f.assessed_gmt::DATE BETWEEN '2025-03-01' AND '2025-04-30'-- CURRENT_DATE - INTERVAL '1 week'
ORDER BY 2,1