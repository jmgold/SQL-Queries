...
GROUP BY 1
HAVING
COUNT(*) FILTER(WHERE f.assessed_gmt::DATE BETWEEN '2025-05-01' AND '2025-08-31') > 0
)
...
AND f.assessed_gmt::DATE BETWEEN '2025-05-01' AND '2025-08-31'-- CURRENT_DATE - INTERVAL '1 week'
ORDER BY 2,1