...
GROUP BY 1
HAVING
COUNT(*) FILTER(WHERE f.assessed_gmt::DATE BETWEEN '2023-05-01' AND '2023-06-30') > 0
)
...
AND f.assessed_gmt::DATE BETWEEN '2023-05-01' AND '2023-06-30'-- CURRENT_DATE - INTERVAL '1 week'
ORDER BY 2,1