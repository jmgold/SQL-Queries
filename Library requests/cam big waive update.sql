...
GROUP BY 1
HAVING
COUNT(*) FILTER(WHERE f.assessed_gmt::DATE BETWEEN '2024-12-01' AND '2025-02-28') > 0
)
...
AND f.assessed_gmt::DATE BETWEEN '2024-12-01' AND '2025-02-28'-- CURRENT_DATE - INTERVAL '1 week'
ORDER BY 2,1