...
GROUP BY 1
HAVING
COUNT(*) FILTER(WHERE f.assessed_gmt::DATE BETWEEN '2022-09-01' AND '2022-10-31') >0
)
...
AND f.assessed_gmt::DATE BETWEEN '2022-09-01' AND '2022-10-31'-- CURRENT_DATE - INTERVAL '1 week'
ORDER BY 2,1