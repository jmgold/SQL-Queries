...
AND (REPLACE(d.index_entry, ' ', '') LIKE '%leonardodavinci14521519%' AND NOT REPLACE(d.index_entry, ' ', '') LIKE '%fiction%' AND NOT REPLACE(d.index_entry, ' ', '') LIKE '%comicbooksstripsetc%')
WHERE
