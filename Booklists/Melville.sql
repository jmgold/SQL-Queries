...
AND (REPLACE(d.index_entry, ' ', '') LIKE '%melvilleherman1819%' OR REPLACE(d.index_entry, ' ', '') LIKE '%seastoriesamerican%' OR REPLACE(d.index_entry, ' ', '') LIKE '%whaling%' OR REPLACE(d.index_entry, ' ', '') LIKE '%whales%')
