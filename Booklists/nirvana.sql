...
ON
b.bib_record_id = d.record_id 
AND ((d.varfield_type_code = 'd'
AND (REPLACE(d.index_entry, ' ', '') LIKE '%cobainkurt1967%' OR REPLACE(d.index_entry, ' ', '') LIKE '%nirvanamusicalgroup%'))
OR(d.varfield_type_code = 'a' AND REPLACE(d.index_entry, ' ', '') LIKE '%nirvanamusicalgroup%'))
