...
--Limit to a subject
AND (REPLACE(d.index_entry, ' ', '') LIKE 'berlinwallberlingermany19611989%' OR REPLACE(d.index_entry, ' ', '') LIKE 'germanyhistoryunification1990' OR REPLACE(d.index_entry, ' ', '') LIKE 'coldwar')
