...
AND (REPLACE(d.index_entry, ' ', '') LIKE '%arpanet%' OR REPLACE(d.index_entry, ' ', '') LIKE '%internet%'OR REPLACE(d.index_entry, ' ', '') LIKE '%socialmedia%' OR REPLACE(d.index_entry, ' ', '') LIKE '%computernetworks%' OR REPLACE(d.index_entry, ' ', '') LIKE '%telecommunication%')
AND REPLACE(d.index_entry, ' ', '') LIKE '%history%' AND REPLACE(d.index_entry, ' ', '') NOT LIKE '%political%'
