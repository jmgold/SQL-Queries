...
Produces list for posting at https://www.minlib.net
*/
...
--Limit to subject(s)
AND REPLACE(d.index_entry, ' ', '') LIKE '%libraries%' AND (REPLACE(d.index_entry, ' ', '') LIKE '%community%' OR REPLACE(d.index_entry, ' ', '') LIKE '%history%' OR REPLACE(d.index_entry, ' ', '') LIKE '%fiction%') AND REPLACE(d.index_entry, ' ', '') NOT LIKE '%fiction%'
