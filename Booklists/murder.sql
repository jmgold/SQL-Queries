...
AND ((REPLACE(d.index_entry, ' ', '') LIKE '%truecrimestories%' OR REPLACE(d.index_entry, ' ', '') LIKE '%murderunitedstatescasestudies%') AND REPLACE(d.index_entry, ' ', '') NOT LIKE '%fiction%')
